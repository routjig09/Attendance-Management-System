...
haarcasecade_path = os.path.join(os.getcwd(), "haarcascade_frontalface_default.xml")
trainimagelabel_path = os.path.join(os.getcwd(), "TrainingImageLabel", "Trainner.yml")
trainimage_path = os.path.join(os.getcwd(), "TrainingImage")
studentdetail_path = os.path.join(os.getcwd(), "StudentDetails", "studentdetails.csv")
